  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          G.test(e)
            ? (r.color.push(a), i.push(Rc), n.push(G.parse(e)))
            : e.startsWith(Bc)
...
function Ke({ split: e, types: t }) {
  ...
  return (r) => {
    ...
    for (let a = 0; a < n; a++)
      if (((i += e[a]), r[a] !== void 0)) {
        let e = t[a];
        e === Lc ? (i += Sc(r[a])) : e === Rc ? (i += G.transform(r[a])) : (i += r[a]);
      }
    return i;
  };
}
...
function gt(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = zs(Array.isArray(t) ? t[n] || F : t, a)), r.push(a));
  }
  return r;
}
...
function jt() {
  if (El) {
    let e = Array.from(wl).filter((e) => e.needsMeasurement),
  ...
  ((El = !1), (Tl = !1), wl.forEach((e) => e.complete(Dl)), wl.clear());
}
function Mt() {
  wl.forEach((e) => {
...
function Pt(e, t, n) {
  kl(t) ? e.style.setProperty(t, n) : (e.style[t] = n);
}
function Ft(e, t) {
  let n = Ne(e);
  return () => Al[t] ?? n();
...
function zt({ type: e, ...t }) {
  return Rt(e) && Nl() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Bt(e) {
  return e in Ll;
}
function Vt(e) {
  typeof e.ease == `string` && Bt(e.ease) && (e.ease = Ll[e.ease]);
}
function Ht(e) {
  ((e.duration = 0), (e.type = `keyframes`));
}
function Ut(e) {
  for (let t = 0; t < e.length; t++) if (typeof e[t] == `string` && Vl.test(e[t])) return !0;
  return !1;
}
function Wt(e) {
  let {
...
function Zt(e) {
  for (let t in e) if (!iu.has(t)) return !0;
  return !1;
}
function Qt(e) {
  let t = ou.exec(e);
...
function fn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    r.start(au(t, r, i, h && su.has(t) ? { type: !1 } : o, e, m));
    let g = r.animation;
    g && d.push(g);
  }
  if (o) {
...
function _n(e, t) {
  let n = Su(e);
  return (Cu.has(n) || (n = K), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
function vn(e) {
...
function yn(e, t, n) {
  ...
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !wu.has(t) && We(t).values.length && (i = e[r]), r++);
  }
...
function Dn(e) {
  return Mu.has(e.tagName) || e.isContentEditable === !0;
}
function On(e) {
...
function Mn(e, t, n = {}) {
  let [r, i, a] = wn(e, n),
    o = (e) => {
      ...
      if (!jn(e) || Iu.has(e)) return;
      (Pu.add(r), n.stopPropagation && Iu.add(e));
      let a = t(r, e),
        o = { ...i, capture: !0 },
        s = (e, t) => {
          (f.removeEventListener(`pointerup`, c, o),
            f.removeEventListener(`pointercancel`, l, o),
            Pu.has(r) && Pu.delete(r),
            jn(e) && typeof a == `function` && a(e, { success: t }));
        },
        c = (e) => {
          s(e, r === f || r === document || n.useGlobalTarget || Au(r, e.target));
        },
        l = (e) => {
          s(e, !1);
        };
  ...
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? f : e).addEventListener(`pointerdown`, o, i),
        xn(e) &&
          (e.addEventListener(`focus`, (e) => Fu(e, i)),
...
function In() {
  typeof ResizeObserver > `u` || (Ru = new ResizeObserver(Fn));
}
function Ln(e, t) {
  Ru || In();
  let n = bn(e);
  return (
    n.forEach((e) => {
      let n = Lu.get(e);
      (n || ((n = new Set()), Lu.set(e, n)), n.add(t), Ru?.observe(e));
    }),
    () => {
      n.forEach((e) => {
        let n = Lu.get(e);
        (n?.delete(t), n?.size || Ru?.unobserve(e));
      });
    }
  );
}
  ...
  return (
    ...
    () => {
      (Hu.delete(e),
        !Hu.size &&
          typeof Uu == `function` &&
          (f.removeEventListener(`resize`, Uu), (Uu = void 0)));
    }
  );
}
function Bn(e, t) {
...
function Cr(e, t, n) {
  ...
  return (
    a && ((i = !1), (r += `rotate(${Du(a, gu.pathRotation)}) `)),
    (r = r.trim()),
...
function Dr(e) {
  for (let t in e) ((pd[t] = e[t]), hc(t) && (pd[t].isCSSVariable = !0));
}
...
function Pr(e, t, n, r) {
  Tr(e, t, void 0, r);
  for (let n in t.attrs) e.setAttribute(yd.has(n) ? n : ln(n), t.attrs[n]);
}
function Fr(e, t, n) {
  let r = kr(e, t, n);
  for (let n in e)
...
function di(e, t, n, r, i, a) {
  i
    ? ((e.opacity = q(0, n.opacity ?? 1, Id(r))), (e.opacityExit = q(t.opacity ?? 1, 0, Ld(r))))
...
function bi({
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = Gd++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            Wu.value && (Hd.nodes = Hd.calculatedTargetDeltas = Hd.calculatedProjections = 0),
            this.nodes.forEach(Ci),
            this.nodes.forEach(Mi),
            this.nodes.forEach(Ni),
            this.nodes.forEach(wi),
            Wu.addProjectionMetrics && Wu.addProjectionMetrics(Hd));
        }),
        ...
        (R.read(() => {
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              n && n(),
              (n = gi(i, 250)),
              Vd.hasAnimatedSinceResize &&
                ((Vd.hasAnimatedSinceResize = !1), this.nodes.forEach(ji)));
          }));
      }
    ...
    willUpdate(e = !0) {
      ...
      if (
        (f.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && yi(this),
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          Wu.value && Hd.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        Wu.value && Hd.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Wd), this.currentAnimation.stop()),
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Ud.length; t++)
        (vi(`rotate${Ud[t]}`, e, r, this.animationValues),
          vi(`skew${Ud[t]}`, e, r, this.animationValues));
      e.render();
      for (let t in r)
...
function Ji({ children: e, isPresent: t, anchorX: n, anchorY: r, root: a, pop: o }) {
  let s = w(),
    c = i(null),
    l = i({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0, direction: `ltr` }),
    { nonce: d } = y($),
    f = qi(c, e.props?.ref ?? e?.ref);
  return (
    p(() => {
...
function ea() {
  if (uf) return;
  let e = {};
  for (let t in lf) e[t] = { isEnabled: (e) => lf[t].some((t) => !!e[t]) };
  (rr(e), (uf = !0));
}
function ta() {
  return (ea(), ir());
...
function ia(e) {
  typeof e == `function` && (ff = (t) => (t.startsWith(`on`) ? !ra(t) : e(t)));
}
function aa(e, t, n) {
  let r = {};
  for (let i in e)
...
function ua(e) {
  let { initial: t, animate: r } = la(e, y(pf));
  return n(() => ({ initial: t, animate: r }), [da(t), da(r)]);
}
function da(e) {
...
function ga(e, t, r, i) {
  let a = n(() => {
    let n = _f();
    return (Nr(n, t, bd(i), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
    (fa(t, e.style, e), (a.style = { ...t, ...a.style }));
  }
  return a;
}
function _a(e) {
  return typeof e != `string` || e.includes(`-`) ? !1 : !!(vf.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
function va(e, t, r, { latestValues: i }, a, o = !1, s) {
  let c = ((s ?? _a(e)) ? ga : ha)(t, i, a, e),
    u = aa(t, typeof e == `string`, o),
    d = e === l ? {} : { ...u, ...c, ref: r },
    { children: f } = t,
    p = n(() => (X(f) ? f.get() : f), [f]);
...
function xa(e, t, n, r, a, o) {
  ...
  let v = g.current,
    b = y(hf);
  v && !v.projection && a && (v.type === `html` || v.type === `svg`) && Sa(g.current, n, a, b);
  let x = i(!1);
  p(() => {
...
function wa(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  ...
  function s(n, s) {
    ...
    if (!u && f !== void 0) {
      Ea(l, r);
      let t = Da(l);
      ((c = t.MeasureLayout), (d.visualElement = xa(e, p, l, i, t.ProjectionNode, a)));
    }
    return b(pf.Provider, {
      value: d,
      children: [
        c && d.visualElement ? m(c, { visualElement: d.visualElement, ...l }) : null,
        va(e, n, ya(p, d.visualElement, s), p, u, t, a),
      ],
    });
  }
...
function Qa(e) {
  let [t, n] = Xi(),
    r = y(Ms);
  return m(zf, { ...e, layoutGroup: r, switchLayoutGroup: y(hf), isPresent: t, safeToRemove: n });
}
function $a(e, t, n) {
  let { props: r } = e;
...
function to({ root: e, ...t }) {
  ...
  let r = Gf.get(n),
    i = JSON.stringify(t);
  return (r[i] || (r[i] = new IntersectionObserver(qf, { root: e, ...t })), r[i]);
}
function no(e, t, n) {
  let r = to(t);
  return (
...
function ao(e, t, n, r) {
  ...
  let l = r - c;
  i.velocity = l > ep ? 0 : Hs(i.current - s, l);
}
function oo(e, t, n) {
...
function co(e, t, n = 0) {
  let r = 0;
  if ((e in ip && (e = ip[e]), typeof e == `string`)) {
    let t = parseFloat(e);
    e.endsWith(`px`)
      ? (r = t)
      : e.endsWith(`%`)
...
function lo(e, t, n, r) {
  ...
  return (
    typeof e == `number`
      ? (i = [e, e])
      : typeof e == `string` &&
        ((e = e.trim()), (i = e.includes(` `) ? e.split(` `) : [e, ip[e] ? e : `0`])),
    (a = co(i[0], n, r)),
    (o = co(i[1], t)),
    a - o
  );
...
function ho(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  ...
  if ((i.add(a), !cp.has(t))) {
    ...
    (f.addEventListener(`resize`, r),
      t !== document.documentElement && lp.set(t, Bn(t, r)),
  ...
  return (
    ...
    () => {
      ...
      (cp.delete(t),
        n &&
          (pp(t).removeEventListener(`scroll`, n),
          lp.get(t)?.(),
          f.removeEventListener(`resize`, n)));
      let r = fp.get(t);
      (r && (z(r), fp.delete(t)), dp.delete(t));
    }
  );
}
function go(e) {
  return f === void 0 ? !1 : e ? Ml() : jl();
}
function _o(e) {
...
function bo(e) {
  ...
  for (let [t, n] of mp) if (yo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function xo(e) {
  let t = { value: 0 };
  return {
...
function ko(e, t) {
  return f === void 0 ? !1 : e ? Ml() && !!bo(t) : jl();
}
...
function No(e) {
  ((Zl.current = []), e());
  let t = Mo(Zl.current, e);
  return ((Zl.current = void 0), t);
}
function Po(e, t, n, r) {
...
function es(e, { defaultTransition: t = {}, ...n } = {}, r, i) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    if (typeof o == `string`) {
      ...
      l.set(o.name, Yo(d, o.at, u, l));
      continue;
    }
    let [p, m, h = {}] = o;
    h.at !== void 0 && (d = Yo(d, h.at, u, l));
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        let c = rs(e),
          {
        ...
        if (
          (ee > 0 && vt(u, ee), c.length === 1 && c.unshift(null), m && `${m}${xp}`, m && m < xp)
        ) {
          let e = b > 0 ? _ / b : 0;
          b = Jo(b, m, _);
          let t = [...c],
        ...
        let T = w + b;
        (Zo(r, c, y, u, w, T), (g = Math.max(x + b, g)), (f = Math.max(T, f)));
      };
    if (X(p)) {
      let e = ts(p, s);
      _(m, h, ns(`default`, e));
      ...
      for (let n = 0; n < t; n++) {
        ...
        let r = e[n],
          i = ts(r, s);
        for (let e in m) _(m[e], is(h, e), ns(e, i), n, t);
      }
    }
    ((u = d), (d += g));
  }
  return (
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        (c[0] !== 0 && (c.unshift(0), s.unshift(s[0]), l.unshift(bp)),
...
function cs(e, t, n, r) {
  let i = [];
  if (ss(e, t)) i.push(mi(e, (Ko(t) && t.default) || t, n && (n.default || n)));
  else {
    if (e == null) return i;
    let a = qo(e, t, r),
      o = a.length;
...
function ds(e = {}) {
  ...
  function i(e, i, a) {
    let o = [],
      s,
      c = {};
    if ((n !== void 0 && (c.reduceMotion = n), r !== void 0 && (c.skipAnimations = r), us(e))) {
      let { onComplete: n, ...r } = i || {};
      (typeof n == `function` && (s = n), (o = ls(e, { ...c, ...r }, t)));
    } else {
      let { onComplete: n, ...r } = a || {};
      (typeof n == `function` && (s = n), (o = cs(e, i, { ...c, ...r }, t)));
    }
    let l = new Jl(o);
    return (
      s && l.finished.then(s),
...
function ps(e) {
  return typeof e == `object` && !!e && xf in e;
}
function ms(e) {
  if (ps(e)) return e[xf];
}
...
function gs(e) {
  Zd.current && ((Zd.current.isUpdating = !1), Zd.current.blockUpdate(), e && e());
}
function _s() {
  return v(() => {
    let e = Zd.current;
...
function vs(e, t, { root: n, margin: r, amount: i = `some` } = {}) {
  let a = bn(e),
    o = new WeakMap(),
    s = new IntersectionObserver(
      ...
      { root: n, rootMargin: r, threshold: typeof i == `number` ? i : Ep[i] }
    );
  return (a.forEach((e) => s.observe(e)), () => s.disconnect());
}
function ys(e, { root: t, margin: n, amount: r, once: i = !1, initial: a = !1 } = {}) {
  let [o, s] = d(a);
  return (
    c(() => {
...
function Cs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: a, ...o }, s) {
  let l = M(() => Qf[t]),
    u = [],
    d = i(!1),
    f = i(null),
    p = {
      ...
      registerItem: (e, t) => {
        ...
        (r === -1 ? u.push({ value: e, layout: t[n] }) : (u[r].layout = t[n]), u.sort(ws));
      },
      updateOrder: (e, t, n) => {
        if (d.current) return;
        let i = Ss(u, e, t, n);
  ...
  return m(l, {
    ...
    ref: h,
    ignoreStrict: !0,
    children: m(kp.Provider, { value: p, children: e }),
  });
}
function ws(e, t) {
...
function Ts() {
  if (Ip) {
    let e = Ds(Ip, `y`);
    e && (Fp.delete(e), Pp.delete(e));
    let t = Ds(Ip, `x`);
    (t && t !== e && (Fp.delete(t), Pp.delete(t)), (Ip = null));
  }
}
function Es(e, t) {
...
function Os(e, t, n) {
  ...
  if (o < jp) {
    let e = 1 - o / jp;
    return { amount: -Mp * e * e, edge: `start` };
  } else if (s < jp) {
    let e = 1 - s / jp;
    return { amount: Mp * e * e, edge: `end` };
  }
...
function ks(e, t, n, r) {
  ...
  let i = Ds(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Os(t - (n === `x` ? f.scrollX : f.scrollY), i, n);
  if (o === null) {
    (Fp.delete(i), Pp.delete(i));
    return;
  }
  let s = Fp.get(i),
  ...
  return m(l, {
    ...
    onDrag: (e, t) => {
      let { velocity: r, point: a } = t,
        o = d[p].get();
      (g(n, o, r[p]), ks(_.current, a[p], p, r[p]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Ts(), a && a(e, t));
    },
...
var Ms,
  ...
  Rp = t(() => {
    (o(),
      ...
      (Ac = { test: Tc(`#`), parse: He, transform: kc.transform }),
      (jc = (e) => ({
      ...
      (Mc = jc(`vh`)),
      (Nc = jc(`vw`)),
      (Pc = { ...U, parse: (e) => U.parse(e) / 100, transform: (e) => U.transform(e * 100) }),
      (Fc = {
        test: Tc(`hsl`, `hue`),
      ...
      (Uc = (e) => (typeof e == `number` ? 0 : G.test(e) ? G.getAnimatableNone(e) : e)),
      ...
      (ll = class extends sl {
        ...
        initAnimation() {
          ...
          s !== St &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = zs(cl, at(o[0], o[1]))), (o = [0, 100]));
      ...
      (Ol = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (wl.add(this), Tl || ((Tl = !0), R.read(Mt), R.resolveKeyframes(jt)))
        ...
        cancel() {
          this.state === `scheduled` && (wl.delete(this), (this.state = `pending`));
        }
        resume() {
      ...
      (kl = (e) => e.startsWith(`--`)),
      (Al = {}),
      (jl = Ft(() => f.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Ml = Ft(() => f.ViewTimeline !== void 0, `viewTimeline`)),
      (Nl = Ft(() => {
        try {
      ...
      (Pl = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`),
      (Fl = {
        linear: `linear`,
        ease: `ease`,
        easeIn: `ease-in`,
      ...
      (Ll = { anticipate: Qs, backInOut: Zs, circInOut: tc }),
      (Rl = 10),
      (zl = class extends Il {
        constructor(e) {
          (Vt(e),
        ...
        updateMotionValue(e) {
          ...
          let o = new ll({ ...a, autoplay: !1 }),
            s = Math.max(Rl, V.now() - this.startTime),
            c = N(0, Rl, s - Rl),
            l = o.sample(s).value,
            { name: u } = this.options;
          (i && u && Pt(i, u, l),
      ...
      (Bl = new Set([`opacity`, `clipPath`, `filter`, `transform`])),
      ...
      (Ul = Ne(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Wl = (e, t) =>
        t !== `zIndex` &&
        !!(
          typeof e == `number` ||
      ...
      (Kl = class extends sl {
        ...
        onKeyframesResolved(e, t, n, r) {
          ...
          let d = {
              startTime: r
                ? this.resolvedAt && this.resolvedAt - this.createdAt > Gl
                  ? this.resolvedAt
                  : this.createdAt
                : void 0,
              finalKeyframe: t,
      ...
      (Ql = class {
        ...
        setCurrent(e) {
          ((this.current = e),
            ...
            this.canTrackVelocity === null &&
              e !== void 0 &&
              (this.canTrackVelocity = Xl(this.current)));
        }
      ...
      (nu = { type: `keyframes`, ease: [0.25, 0.1, 0.35, 1], duration: 0.3 }),
      (ru = (e, { keyframes: t }) =>
        t.length > 2 ? tu : bl.has(e) ? (e.startsWith(`scale`) ? eu(t[1]) : $l) : nu),
      (iu = new Set([
        `when`,
        `delay`,
        `delayChildren`,
      ...
      (au =
        ...
        (o) => {
          ...
          return s.isSync ? new ll(u) : new Kl(u);
        }),
      (ou = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u),
      (su = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...yl])),
      (cu = (e) => Array.isArray(e)),
      (X = (e) => !!(e && e.getVelocity)),
      (lu = `framerAppearId`),
      (uu = `data-` + ln(lu)),
      (du = (e) => (t) => t.test(e)),
      (fu = [yc, W, U, H, Nc, Mc, { test: (e) => e === `auto`, parse: (e) => e }]),
      (pu = (e) => fu.find(du(e))),
      (mu = {
        rotate: H,
        pathRotation: H,
      ...
      (_u = new Set([`brightness`, `contrast`, `saturate`, `opacity`])),
      (vu = /\b([a-z-]*)\(.*?\)/gu),
      (yu = {
        ...K,
        getAnimatableNone: (e) => {
      ...
      [...Eu],
      (Du = (e, t) => (t && typeof e == `number` ? t.transform(e) : e)),
      ({ schedule: Ou, cancel: ku } = Re(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
      (Au = (e, t) => (t ? e === t || Au(e, t.parentElement) : !1)),
      (ju = (e) =>
        e.pointerType === `mouse`
          ? typeof e.button != `number` || e.button <= 0
          : e.isPrimary !== !1),
      (Mu = new Set([`BUTTON`, `INPUT`, `SELECT`, `TEXTAREA`, `A`])),
      (Nu = new Set([`INPUT`, `SELECT`, `TEXTAREA`])),
      (Pu = new WeakSet()),
      (Fu = (e, t) => {
      ...
      (Bu = zu(`inline`, `width`, `offsetWidth`)),
      (Vu = zu(`block`, `height`, `offsetHeight`)),
      (Hu = new Set()),
      (Wu = { value: null, addProjectionMetrics: null }),
      (Gu = [...fu, G, K]),
      (Ku = (e) => Gu.find(du(e))),
      ...
      (id = class {
        ...
        bindToMotionValue(e, t) {
          if (
            ...
            t.accelerate && Bl.has(e) && this.current instanceof HTMLElement)
          ) {
      ...
      (Vd = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 }),
      (Hd = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 }),
      (Ud = [``, `X`, `Y`, `Z`]),
      (Wd = 1e3),
      (Gd = 0),
      (Kd = { duration: 0.45, ease: [0.4, 0, 0.1, 1] }),
      (qd = (e) => s !== void 0 && s.userAgent && s.userAgent.toLowerCase().includes(e)),
      (Jd = qd(`applewebkit/`) && !qd(`chrome/`) ? Math.round : F),
      (Yd = bi({
      ...
      (Xd = (e) => !e.isLayoutDirty && e.willUpdate(!1)),
      (Zd = { current: void 0 }),
      (Qd = bi({
        ...
        defaultParent: () => {
          if (!Zd.current) {
            let e = new Yd({});
            (e.mount(f), e.setOptions({ layoutScroll: !0 }), (Zd.current = e));
          }
          return Zd.current;
        },
        resetTransform: (e, t) => {
      ...
      (nf = ({
        ...
        if (g !== w) {
          ...
          return (s === `wait` && E.length && (e = E), te(Zi(e)), ee(g), null);
        }
        let { forceRender: ne } = y(Ms);
        return m(S, {
          children: T.map((e) => {
            let n = tf(e),
      ...
      (af = (e) => e === !0),
      (of = (e) => af(e === !0) || e === `id`),
      (sf = ({ children: e, id: t, inherit: r = !0 }) => {
        let a = y(Ms),
          o = y(rf),
          [s, c] = $i(),
          l = i(null),
        ...
        l.current === null &&
          (of(r) && u && (t = t ? u + `-` + t : u),
          (l.current = { id: t, group: (af(r) && a.group) || Wi() }));
        let d = n(() => ({ ...l.current, forceRender: s }), [c]);
        return m(Ms.Provider, { value: d, children: e });
      }),
      (cf = a({ strict: !1 })),
      (lf = {
        animation: [
    ...
    ((pf = a({})),
      ...
      (hf = a({})),
      (gf = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} })),
      (_f = () => ({ ...gf(), attrs: {} })),
      (vf = [
        `animate`,
        `circle`,
      ...
      (yf = mf({ scrapeMotionValuesFromProps: kr, createRenderState: gf })),
      (bf = mf({ scrapeMotionValuesFromProps: Fr, createRenderState: _f })),
      ...
      (wf = class extends od {
        constructor() {
          (super(...arguments), (this.id = Cf++), (this.isExitComplete = !1));
        }
        update() {
      ...
      (Tf = { animation: { Feature: Sf }, exit: { Feature: wf } }),
      (Ef = (e) => (t) => ju(t) && e(t, ka(t))),
      (Df = (e, t) => Math.abs(e - t)),
      (Of = (e, t) => ((t.isSVG ?? _a(e)) ? new xd(t) : new md(t, { allowProjection: e !== l }))),
      (kf = ({ current: e }) => (e ? e.ownerDocument.defaultView : null)),
      (Af = new Set([`auto`, `scroll`])),
      (jf = class {
        constructor(
          e,
          t,
        ...
        startScrollTracking(e) {
          ...
          for (; t; ) {
            ...
            ((Af.has(e.overflowX) || Af.has(e.overflowY)) &&
      ...
      (Pf = class {
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (cn(this.visualElement, e), n.start(au(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
        ...
        addListeners() {
          ...
          let o = hi(f, `resize`, () => this.scalePositionWithinConstraints()),
      ...
      (Bf = { pan: { Feature: Lf }, drag: { Feature: Ff, ProjectionNode: Qd, MeasureLayout: Qa } }),
      (Vf = class extends od {
        mount() {
        ...
        startObserver() {
          ...
          let { viewport: e = {} } = this.node.getProps(),
            ...
            a = {
              ...
              rootMargin: n,
              threshold: typeof r == `number` ? r : Jf[r],
            },
            o = (e) => {
      ...
      (Zf = { layout: { ProjectionNode: Qd, MeasureLayout: Qa } }),
      (Qf = Oa({ ...Tf, ...Xf, ...Bf, ...Zf }, Of)),
      ($f = { renderer: Of, ...Tf, ...Xf }),
      { ...$f, ...Bf, ...Zf },
      { ...Tf },
      (ep = 50),
      ...
      (np = () => ({ time: 0, x: tp(), y: tp() })),
      (rp = { x: { length: `Width`, position: `Left` }, y: { length: `Height`, position: `Top` } }),
      (ip = { start: 0, center: 0.5, end: 1 }),
      (ap = [0, 0]),
      (op = {
        Enter: [
          [0, 1],
      ...
      (dp = new WeakMap()),
      (fp = new WeakMap()),
      (pp = (e) => (e === document.scrollingElement ? f : e)),
      (mp = [
        [op.Enter, `entry`],
        [op.Exit, `exit`],
        [op.Any, `cover`],
      ...
      (hp = { start: 0, end: 1 }),
      (gp = new Map()),
      (_p = () => ({ scrollX: D(0), scrollY: D(0), scrollXProgress: D(0), scrollYProgress: D(0) })),
      (vp = (e) => (e ? !e.current : !1)),
      (yp = class extends Ql {
        constructor() {
        ...
        add(e) {
          (bl.has(e) || Bl.has(e)) && ((this.isEnabled = !0), this.update());
        }
        update() {
      ...
      (bp = `easeInOut`),
      (xp = 20),
      (Sp = (e) => typeof e == `number`),
      (Cp = (e) => e.every(Sp)),
      (wp = ds()),
      (Tp = fs),
      (Ep = { some: 0, all: 1 }),
      (Dp = () => ({})),
      mf({ scrapeMotionValuesFromProps: Dp, createRenderState: Dp }),
      (Op = {}),
      fe(Op, { Group: () => Ap, Item: () => Lp }),
      (kp = a(null)),
      (Ap = _(Cs)),
      (jp = 50),
      (Mp = 25),
...
//# sourceMappingURL=motion.B8Fudg3-.mjs.map
