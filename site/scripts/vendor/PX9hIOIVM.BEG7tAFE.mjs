...
import { C as p, a as m, r as ne, t as re } from "./motion.B8Fudg3-.mjs";
import {
  B as h,
  C as g,
  J as _,
...
var w,
  ...
  me = e(() => {
    (d(),
      ...
      (F.displayName = `Text`),
      b(F, {
        Z1QnXqTEb: { defaultValue: `rgb(0, 0, 0)`, hidden: !1, title: `Fill`, type: x.Color },
        vtL2DrqsL: { defaultValue: `rgb(0, 0, 0)`, hidden: !0, title: `Fill 2`, type: x.Color },
      }));
  }),
  I,
  L,
...
e(() => {
  (d(),
    ...
    (W = h(U)),
    (G = h(F)),
    (K = y(F, { nodeId: `pBR1Ew0r8`, override: fe, scopeId: `PX9hIOIVM` })),
    (q = ae(S(y(p.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (J = `framer-6jWyo`),
    ...
    (Q = C(
      c(function (e, t) {
        let n = r(null),
          i = t ?? n,
          a = ee(),
          { activeLocale: o, setLocale: c } = le();
        ce();
        let { style: l, className: d, layoutId: f, variant: te, ...m } = xe(e),
          {
            baseVariant: re,
            classNames: h,
            ...
            setVariant: b,
            variants: x,
          } = oe({ defaultVariant: `HK2sXlagE`, ref: i, variant: te, variantClassNames: Y }),
          S = Se(e, x),
          C = v(J);
        return s(ne, {
          id: f ?? a,
            ...
            children: s(ye, {
              ...
              children: s(se, {
                ...
                children: u(q, {
                  ...
                  __targetOpacity: 1,
                  className: `${v(C, `framer-n0ccwk`, d, h)} framer-bmpgw8`,
    ...
    ie(Q, [{ explicitInter: !0, fonts: [] }, ...W, ...G], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.BEG7tAFE.mjs.map
