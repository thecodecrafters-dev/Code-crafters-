...
export default function Services() {
  return (
    <section id="services" className="py-24 px-6 relative bg-black/60 backdrop-blur-md border-b border-white/[0.03] overflow-hidden">
        ...
        >
          {services.map((service, i) => (
            <motion.div
              ...
              className="group relative p-12 border-r border-b border-white/10 bg-white/[0.01] backdrop-blur-xl hover:bg-white/[0.03] transition-colors duration-500 overflow-hidden"
            >
